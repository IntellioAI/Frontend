        ...
        >
          ...
          {!output && !error && (
            <div className="flex flex-col items-center justify-center h-full text-gray-400 p-8">
              ...
              <div className="text-sm font-medium">AI-Powered Console</div>
              <div className="text-xs text-center mt-1 max-w-xs">
                Run your code to see AI-generated analysis, execution results, and debugging insights
              </div>
              <div className="mt-2 flex items-center space-x-1 text-xs text-indigo-500">
